...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size, save_expert_data_to_disk=False):
        """
        :param itr:
        :param load_initial_expertdata:  path to expert data pkl file
        :param collect_policy:  the current policy using which we collect data
        ...
        if itr == 0 and load_initial_expertdata is not None:
            with open(load_initial_expertdata, "rb") as rf:
                loaded_path = pickle.load(rf)
    ...
    # TODO: get this from Piazza
        # TODO: get this from Piazza
        # print('\nTraining agent using sampled data from replay buffer...')  ### note: for a clean terminal output, this line is commented out
        all_logs = []
